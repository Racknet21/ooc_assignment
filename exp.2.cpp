...
res.real=C1.real + C2.real; // adding Imaginary part of complex numbers 
res.imaginary =C1.imaginary +C2.imaginary; //returning the sum 
return res; 
}
};
// Main Class 
...
// for Storing the sum 
Complex C; // calling addComplexNumber0 method 
