#include <iostream> // Include necessary header for inputoutput stream
...
Circle circle(8.0);
Rectangle rectangle(4.2, 7.0); // Create a Rectangle object with length 4.2 and width 8.0
Triangle triangle(2.0, 4.0, 3.2); // Create a Triangle object with sides 4.0, 4.0, and 3.2
